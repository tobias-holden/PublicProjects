...
theme_presentation<- function(base_size = 8, base_family = "") {
  ...
  theme_bw(base_size = base_size, base_family = base_family) %+replace%
    theme(
      ...
      axis.text.y = element_text(size=8,colour="white",hjust=1),
      axis.ticks =  element_line(colour = "white"), 
      axis.title.x= element_text(size=8,colour="white"),
      axis.title.y= element_text(size=8,angle=90,colour="white"),
      axis.title.y.right= element_text(size=8,angle=90,colour="white"),
      ...
      plot.title =element_text(size=8,colour="white"), 
